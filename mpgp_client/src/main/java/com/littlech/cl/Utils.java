...
public static G30 getCopy(G30 in) {
	...
	public static boolean actionRequestsEqual(A12 ar1, A12 ar2) {
		...
		throw new IllegalArgumentException(ar1.getClass().getCanonicalName());
	}
	...
	public static B6 charToRank(char c) {
		int ordinal = (int)c - 65;
		return B6.values()[ordinal];
		/*
		switch (c) {
		case '2':
			return B6.B_7;
	...
	public static B1 charToSuit(char c) {
		int ordinal = (int)c - 48;
		return B1.values()[ordinal];
		/*
		switch (c) {
		case 'C':
			return B1.B_2;
	...
	public static String getPresentableFormatForTable(
		...
		return "B28{" + printTables(_table.getB29()) + "}";
	}
	...
	public static void removePairByBottom(List<B23> value,
		...
		throw new IllegalArgumentException("B20 "
	...
	public static G30 getTableByID(List<G30> tables, String id1) {
		...
		throw new IllegalArgumentException("Not found: " + id1);
	}
...
*/
	...
	public static void checkCommand(D4 _cmd, C1 _code) {
		...
		if (!_code.equals(code)) {
			throw new IllegalArgumentException(); // "Command code " + code + " does not match that of expected " + _code);
		}
